...
public class Endpoints {
    ...
    public  static final String doctor_info_for_doctor_list=BASE_URL + "doctor_info_for_doctor_list";
    ...
    public  static final String retrive_comment=BASE_URL + "retrieve_comment";
    ...
    public  static final String select_doctor_info_for_search=BASE_URL + "select_doctor_info_for_search";


    public  static final String select_user_info_for_profile=BASE_URL + "select_user_info_for_profile";

    public  static final String forgetpasswordpost=BASE_URL + "forgetpasswordpost";

    public  static final String select_user_info_for_editprofile=BASE_URL + "select_user_info_for_editprofile";

    public  static final String saveEditInfo=BASE_URL + "saveEditInfo";


    public  static final String saveChangePhoto=BASE_URL + "saveChangePhoto";


    public  static final String selectReport=BASE_URL + "selectReport";

    public  static final String resetPasswordPost=BASE_URL + "resetPasswordPost";
